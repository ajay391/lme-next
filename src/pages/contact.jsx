        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <form className="space-y-5">
            <div>
              ...
              <input
                type="text"
                className="w-full mt-1 border border-gray-300 rounded-sm px-4 py-2 focus:outline-none focus:ring-1 focus:ring-red-500"
            ...
            <div>
              ...
              <textarea
                className="w-full mt-1 border border-gray-300 rounded-sm px-4 py-2 h-32 resize-none focus:outline-none focus:ring-1 focus:ring-red-500"
            ...
            <button
              type="submit"
              className="bg-red-500 text-white font-medium px-6 py-2 rounded-sm hover:bg-red-600 transition"
            >
              Send Message
            </button>
          </form>
