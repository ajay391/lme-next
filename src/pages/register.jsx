...
export default function RegisterPage() {
  ...
  return (
    <>
      <Head>
        <title>Register | Last Man On Earth </title>
      ...
      <div className="py-16 sm:py-20 flex items-center justify-center bg-gray-100 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md md:max-w-5xl w-full bg-white shadow-lg rounded-lg overflow-hidden grid grid-cols-1 md:grid-cols-2">
          {/* Left Side Image */}
