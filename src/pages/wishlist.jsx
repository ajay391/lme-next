  ...
  return (
    <div className="max-w-6xl mx-auto px-5 sm:px-8 py-10 min-h-[70vh]">
      ...
      {wishlistItems.length === 0 ? (
        ...
        <>
          {/* Header Row */}
          <div className="hidden sm:grid grid-cols-5 gap-4 px-4 py-3 border-b font-medium text-gray-700 text-sm ">
            <div className="col-span-2 poppins-font">Product</div>
            <div className="poppins-font">Unit Price</div>
          ...
          <div className="space-y-6 sm:space-y-0 mt-4 sm:mt-0">
            {wishlistItems.map((item) => {
              ...
              return (
                <div
                  key={item.id}
                  className="grid grid-cols-1 sm:grid-cols-5 gap-4 items-center bg-white shadow-sm px-4 py-6 rounded-sm border sm:border-0 sm:border-b"
                >
                  {/* Image + Product */}
                  ...
                  <div className="text-left">
                    <div className="flex justify-end sm:justify-start sm:flex-row gap-2 sm:items-center text-left">
                      ...
                      <button
                        ...
                        className="text-sm py-2 px-4 text-white bg-black rounded-sm hover:bg-gray-800"
                      >
                        Add to Cart
                      </button>
                      ...
                      <button
                        ...
                        className="text-sm p-2 text-white bg-red-500 rounded-sm hover:bg-red-600"
                      >
          ...
          <div className="mt-8 flex justify-end">
            <button
              ...
              className=" text-white px-4 py-2 rounded-sm transition bg-red-500 hover:bg-red-600"
            >
              Clear All
            </button>
          </div>
